...
func TestPrivateCloudProfile(t *testing.T) {
	RegisterFailHandler(Fail)
	RunSpecs(t, "Test Integration ControllerManager PrivateCloudProfile Suite")
}

const testID = "privatecloudprofile-controller-test"
...
var _ = BeforeSuite(func() {
	...
	mgr, err := manager.New(restConfig, manager.Options{
		...
		Cache: cache.Options{
			...
			ByObject: map[client.Object]cache.ByObject{
				&gardencorev1beta1.PrivateCloudProfile{}: {
	...
	Expect((&privatecloudprofile.Reconciler{
