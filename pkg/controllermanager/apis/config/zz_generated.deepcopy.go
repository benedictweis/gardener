...
func (in *ControllerManagerControllerConfiguration) DeepCopyInto(out *ControllerManagerControllerConfiguration) {
	*out = *in
	...
	if in.PrivateCloudProfile != nil {
		in, out := &in.PrivateCloudProfile, &out.PrivateCloudProfile
		*out = new(PrivateCloudProfileControllerConfiguration)
		(*in).DeepCopyInto(*out)
	}
	if in.Project != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PrivateCloudProfileControllerConfiguration) DeepCopyInto(out *PrivateCloudProfileControllerConfiguration) {
	*out = *in
	if in.ConcurrentSyncs != nil {
		in, out := &in.ConcurrentSyncs, &out.ConcurrentSyncs
		*out = new(int)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PrivateCloudProfileControllerConfiguration.
func (in *PrivateCloudProfileControllerConfiguration) DeepCopy() *PrivateCloudProfileControllerConfiguration {
	if in == nil {
		return nil
	}
	out := new(PrivateCloudProfileControllerConfiguration)
