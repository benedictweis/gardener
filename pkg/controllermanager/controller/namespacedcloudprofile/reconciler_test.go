...
var _ = Describe("Reconciler", func() {
	...
	It("should return nil because object not found", func() {
		c.EXPECT().Get(gomock.Any(), kubernetesutils.Key(namespacedCloudProfileName), gomock.AssignableToTypeOf(&gardencorev1beta1.NamespacedCloudProfile{})).Return(apierrors.NewNotFound(schema.GroupResource{}, ""))
	...
	It("should return err because object reading failed", func() {
		c.EXPECT().Get(gomock.Any(), kubernetesutils.Key(namespacedCloudProfileName), gomock.AssignableToTypeOf(&gardencorev1beta1.NamespacedCloudProfile{})).Return(fakeErr)
