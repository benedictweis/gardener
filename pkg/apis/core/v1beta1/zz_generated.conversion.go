...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*NamespacedCloudProfileParent)(nil), (*core.NamespacedCloudProfileParent)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_NamespacedCloudProfileParent_To_core_NamespacedCloudProfileParent(a.(*NamespacedCloudProfileParent), b.(*core.NamespacedCloudProfileParent), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*core.NamespacedCloudProfileParent)(nil), (*NamespacedCloudProfileParent)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_core_NamespacedCloudProfileParent_To_v1beta1_NamespacedCloudProfileParent(a.(*core.NamespacedCloudProfileParent), b.(*NamespacedCloudProfileParent), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1beta1_NamespacedCloudProfileParent_To_core_NamespacedCloudProfileParent(in *NamespacedCloudProfileParent, out *core.NamespacedCloudProfileParent, s conversion.Scope) error {
	out.Kind = in.Kind
	out.Name = in.Name
	return nil
}

// Convert_v1beta1_NamespacedCloudProfileParent_To_core_NamespacedCloudProfileParent is an autogenerated conversion function.
func Convert_v1beta1_NamespacedCloudProfileParent_To_core_NamespacedCloudProfileParent(in *NamespacedCloudProfileParent, out *core.NamespacedCloudProfileParent, s conversion.Scope) error {
	return autoConvert_v1beta1_NamespacedCloudProfileParent_To_core_NamespacedCloudProfileParent(in, out, s)
}

func autoConvert_core_NamespacedCloudProfileParent_To_v1beta1_NamespacedCloudProfileParent(in *core.NamespacedCloudProfileParent, out *NamespacedCloudProfileParent, s conversion.Scope) error {
	out.Kind = in.Kind
	out.Name = in.Name
	return nil
}

// Convert_core_NamespacedCloudProfileParent_To_v1beta1_NamespacedCloudProfileParent is an autogenerated conversion function.
func Convert_core_NamespacedCloudProfileParent_To_v1beta1_NamespacedCloudProfileParent(in *core.NamespacedCloudProfileParent, out *NamespacedCloudProfileParent, s conversion.Scope) error {
	return autoConvert_core_NamespacedCloudProfileParent_To_v1beta1_NamespacedCloudProfileParent(in, out, s)
}
...
func autoConvert_v1beta1_NamespacedCloudProfileSpec_To_core_NamespacedCloudProfileSpec(in *NamespacedCloudProfileSpec, out *core.NamespacedCloudProfileSpec, s conversion.Scope) error {
	...
	out.SeedSelector = (*core.SeedSelector)(unsafe.Pointer(in.SeedSelector))
	out.VolumeTypes = *(*[]core.VolumeType)(unsafe.Pointer(&in.VolumeTypes))
	if err := Convert_v1beta1_NamespacedCloudProfileParent_To_core_NamespacedCloudProfileParent(&in.Parent, &out.Parent, s); err != nil {
		return err
	}
	return nil
}
...
func autoConvert_core_NamespacedCloudProfileSpec_To_v1beta1_NamespacedCloudProfileSpec(in *core.NamespacedCloudProfileSpec, out *NamespacedCloudProfileSpec, s conversion.Scope) error {
	...
	out.SeedSelector = (*SeedSelector)(unsafe.Pointer(in.SeedSelector))
	out.VolumeTypes = *(*[]VolumeType)(unsafe.Pointer(&in.VolumeTypes))
	if err := Convert_core_NamespacedCloudProfileParent_To_v1beta1_NamespacedCloudProfileParent(&in.Parent, &out.Parent, s); err != nil {
		return err
	}
	return nil
}
